#define monojet_PhotonControlRegion_cxx
...
void monojet_PhotonControlRegion::setMask() {

  analysisMask.setName("monojet photon control region selection (inclusive)");
  ...
  analysisMask_monoJ.setName("monojet photon control region selection");
...
void monojet_PhotonControlRegion::setControlSampleSpecificParameter() {
...
void monojet_PhotonControlRegion::loop(vector< Double_t > &yRow, vector< Double_t > &eRow, vector< Double_t > &uncRow, 

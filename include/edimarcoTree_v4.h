...
// Thu Dec  3 17:54:52 2015 by ROOT version 5.34/18
...
public :
   ...
   Float_t         HLT_BIT_HLT_PFMET170_v;
   Float_t         HLT_BIT_HLT_PFMET170_HBHECleaned_v;
   Float_t         HLT_BIT_HLT_PFMET170_JetIdCleaned_v;
   Float_t         HLT_Met170;
   Float_t         HLT_BIT_HLT_PFMETNoMu120_NoiseCleaned_PFMHTNoMu120_IDTight_v;
   Float_t         HLT_BIT_HLT_PFMETNoMu120_JetIdCleaned_PFMHTNoMu120_IDTight_v;
   Float_t         HLT_BIT_HLT_PFMETNoMu120_PFMHTNoMu120_IDTight_v;
   Float_t         HLT_MonoJetMetNoMuMHT120;
   Float_t         HLT_BIT_HLT_PFMETNoMu90_NoiseCleaned_PFMHTNoMu90_IDTight_v;
   Float_t         HLT_BIT_HLT_PFMETNoMu90_JetIdCleaned_PFMHTNoMu90_IDTight_v;
   Float_t         HLT_BIT_HLT_PFMETNoMu90_PFMHTNoMu90_IDTight_v;
   Float_t         HLT_MonoJetMetNoMuMHT90;
   Float_t         HLT_BIT_HLT_PFMET300_NoiseCleaned_v;
   Float_t         HLT_BIT_HLT_PFMET300_v;
   Float_t         HLT_BIT_HLT_PFMET300_JetIdCleaned_v;
   Float_t         HLT_Met300;
   ...
   Float_t         FatJet_trimmedMass[7];   //[nFatJet]
   Float_t         FatJet_filteredMass[7];   //[nFatJet]
   ...
   Int_t           nGenPart;
   Int_t           GenPart_motherId[50];   //[nGenPart]
   Int_t           GenPart_grandmotherId[50];   //[nGenPart]
   Int_t           GenPart_sourceId[50];   //[nGenPart]
   Float_t         GenPart_charge[50];   //[nGenPart]
   ...
   Int_t           GenPart_motherIndex[50];   //[nGenPart]
   Int_t           nisoTrack;

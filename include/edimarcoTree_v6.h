...
#ifndef edimarcoTree_v6_h
#define edimarcoTree_v6_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   edimarcoTree_v6(TTree *tree=0);
   virtual ~edimarcoTree_v6();
...
#ifdef edimarcoTree_v6_cxx
edimarcoTree_v6::edimarcoTree_v6(TTree *tree) : fChain(0) 
{
...
edimarcoTree_v6::~edimarcoTree_v6()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t edimarcoTree_v6::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t edimarcoTree_v6::LoadTree(Long64_t entry)
{
...
void edimarcoTree_v6::Init(TTree *tree)
{
...
void edimarcoTree_v6::Show(Long64_t entry)
{
...
Int_t edimarcoTree_v6::Cut(Long64_t entry)
{
...
#endif // #ifdef edimarcoTree_v6_cxx

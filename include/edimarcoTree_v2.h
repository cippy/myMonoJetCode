...
// Tue Jul 21 15:19:47 2015 by ROOT version 5.34/18
// from TTree tree/treeProducerDarkMatterMonoJet
// found on file: tree.root
//////////////////////////////////////////////////////////

#ifndef edimarcoTree_v2_h
#define edimarcoTree_v2_h
...
public :
   ...
   Float_t         nGamma15V;
   Float_t         nGamma175T;
   Float_t         nBTag15;        // added on nov 17
   Float_t         dphijj;
   Float_t         dphijm;         // added on nov 17
   Float_t         weight;
   Float_t         events_ntot;     // added on nov 17
   Float_t         jetclean1;
   Float_t         jetclean2;
   Float_t         phmet_pt;
   Float_t         phmet_phi;
   Float_t         vtxW;             // obsolete
   Int_t           nJetClean;
   Int_t           nTauClean;
   Int_t           nMuSel;
   Int_t           nLepSel;        // added on nov 17 
   Int_t           iM[4];   //[nMuSel]
   ...
   Float_t         JetClean_leadClean[10];   //[nJetClean]    // added on nov 17
   Float_t         TauClean_pt[3];   //[nTauClean]
   Float_t         TauClean_eta[3];   //[nTauClean]
   Float_t         TauClean_phi[3];   //[nTauClean]
   // adding the following the 10th of October 2015 to use new set of trees
   Float_t vtxWeight;
   ...
   Int_t           nFatJet;
   Int_t           FatJet_id[4];   //[nFatJet]
   Int_t           FatJet_puId[4];   //[nFatJet]
   Float_t         FatJet_btagCSV[4];   //[nFatJet]
   Float_t         FatJet_btagCMVA[4];   //[nFatJet]
   Float_t         FatJet_rawPt[4];   //[nFatJet]
   Float_t         FatJet_mcPt[4];   //[nFatJet]
   Int_t           FatJet_mcFlavour[4];   //[nFatJet]
   Int_t           FatJet_mcMatchId[4];   //[nFatJet]
   Float_t         FatJet_pt[4];   //[nFatJet]
   Float_t         FatJet_eta[4];   //[nFatJet]
   Float_t         FatJet_phi[4];   //[nFatJet]
   Float_t         FatJet_mass[4];   //[nFatJet]
   Float_t         FatJet_prunedMass[4];   //[nFatJet]
   Float_t         FatJet_trimmedMass[4];   //[nFatJet]
   Float_t         FatJet_filteredMass[4];   //[nFatJet]
   Float_t         FatJet_tau1[4];   //[nFatJet]
   Float_t         FatJet_tau2[4];   //[nFatJet]
   Float_t         FatJet_tau3[4];   //[nFatJet]
   Float_t         FatJet_topMass[4];   //[nFatJet]
   Float_t         FatJet_minMass[4];   //[nFatJet]
   Float_t         FatJet_nSubJets[4];   //[nFatJet]
   Int_t           nGenPart;
   Int_t           GenPart_motherId[17];   //[nGenPart]
   Int_t           GenPart_grandmotherId[17];   //[nGenPart]
   Int_t           GenPart_sourceId[17];   //[nGenPart]
   Float_t         GenPart_charge[17];   //[nGenPart]
   Int_t           GenPart_status[17];   //[nGenPart]
   Int_t           GenPart_pdgId[17];   //[nGenPart]
   Float_t         GenPart_pt[17];   //[nGenPart]
   Float_t         GenPart_eta[17];   //[nGenPart]
   Float_t         GenPart_phi[17];   //[nGenPart]
   Float_t         GenPart_mass[17];   //[nGenPart]
   ...
   Float_t         LepGood_svRedM[5];   //[nLepGood]
   Float_t         LepGood_svLepSip3d[5];   //[nLepGood]
   Float_t         LepGood_svSip3d[5];   //[nLepGood]
   Float_t         LepGood_svNTracks[5];   //[nLepGood]
   Float_t         LepGood_svChi2n[5];   //[nLepGood]
   Float_t         LepGood_svDxy[5];   //[nLepGood]
   Float_t         LepGood_svMass[5];   //[nLepGood]
   Float_t         LepGood_svPt[5];   //[nLepGood]
   Float_t         LepGood_svMCMatchFraction[5];   //[nLepGood]
   Float_t         LepGood_svMva[5];   //[nLepGood]
   Float_t         LepGood_jetNDau[5];   //[nLepGood]
   Float_t         LepGood_jetNDauCharged[5];   //[nLepGood]
   Float_t         LepGood_jetNDauPV[5];   //[nLepGood]
   Float_t         LepGood_jetNDauNotPV[5];   //[nLepGood]
   Float_t         LepGood_jetmaxSignedSip3D[5];   //[nLepGood]
   Float_t         LepGood_jetmaxSip3D[5];   //[nLepGood]
   Float_t         LepGood_jetmaxSignedSip2D[5];   //[nLepGood]
   Float_t         LepGood_jetmaxSip2D[5];   //[nLepGood]
   Float_t         LepGood_jetPtRelv0[5];   //[nLepGood]
   Float_t         LepGood_jetMass[5];   //[nLepGood]
   Float_t         LepGood_jetPrunedMass[5];   //[nLepGood]
   Float_t         LepGood_jetDecDR[5];   //[nLepGood]
   Float_t         LepGood_jetDecPtRel[5];   //[nLepGood]
   Float_t         LepGood_jetDecPtRatio[5];   //[nLepGood]
   Float_t         LepGood_jetDecPrunedMass[5];   //[nLepGood]
   Float_t         LepGood_jetDecPrunedPtRatio[5];   //[nLepGood]
   Float_t         LepGood_jetDec02DR[5];   //[nLepGood]
   Float_t         LepGood_jetDec02PtRel[5];   //[nLepGood]
   Float_t         LepGood_jetDec02PtRatio[5];   //[nLepGood]
   Float_t         LepGood_jetDec02PrunedPtRatio[5];   //[nLepGood]
   Float_t         LepGood_jetDec02PrunedMass[5];   //[nLepGood]
   Int_t           ngenJet;
   ...
   edimarcoTree_v2(TTree *tree=0);
   virtual ~edimarcoTree_v2();
...
#ifdef edimarcoTree_v2_cxx
edimarcoTree_v2::edimarcoTree_v2(TTree *tree) : fChain(0) 
{
...
edimarcoTree_v2::~edimarcoTree_v2()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t edimarcoTree_v2::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t edimarcoTree_v2::LoadTree(Long64_t entry)
{
...
void edimarcoTree_v2::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("LHEorigWeight", &LHEorigWeight, &b_LHEorigWeight);
...
void edimarcoTree_v2::Show(Long64_t entry)
{
...
Int_t edimarcoTree_v2::Cut(Long64_t entry)
{
...
#endif // #ifdef edimarcoTree_v2_cxx

#define vbfHiggsToInv_wlnuControlRegion_cxx
#include "EmanTreeAnalysis.h"
//#include "vbfHiggsToInvAna.h" // already included in EmanTreeAnalysis.h
//C or C++ header files
#include <stdio.h>
#include <stdlib.h>
...
#ifdef vbfHiggsToInv_wlnuControlRegion_cxx

vbfHiggsToInv_wlnuControlRegion::vbfHiggsToInv_wlnuControlRegion(TTree *tree) : vbfHiggsToInv_LeptonControlRegion(tree) {
...
void vbfHiggsToInv_wlnuControlRegion::setSelections() {
...
void vbfHiggsToInv_wlnuControlRegion::setMask() {
...
void vbfHiggsToInv_wlnuControlRegion::setHistograms() {
...
void vbfHiggsToInv_wlnuControlRegion::setScaleFactorHistograms() {
...
void vbfHiggsToInv_wlnuControlRegion::setHistogramsForTests() {
...
void vbfHiggsToInv_wlnuControlRegion::setHistogramLastBinAsOverFlow(const Int_t hasScaledHistograms = 0) {
...
void vbfHiggsToInv_wlnuControlRegion::setBranchStatusForAnalysis() {
...
void vbfHiggsToInv_wlnuControlRegion::setNumberParameterValue(const std::string parameterName, const Double_t value) {
...
void vbfHiggsToInv_wlnuControlRegion::setControlSampleSpecificParameter() {
...
void vbfHiggsToInv_wlnuControlRegion::setVarFromConfigFile() {
...
Double_t vbfHiggsToInv_wlnuControlRegion::computeEventWeight() {
...
void vbfHiggsToInv_wlnuControlRegion::createSystematicsHistogram() {
...
void vbfHiggsToInv_wlnuControlRegion::loop(vector< Double_t > &yRow, vector< Double_t > &eRow, vector< Double_t > &uncRow, 
				...
				vector< Double_t > &yRow_monoV, vector< Double_t > &eRow_monoV, vector< Double_t > &uncRow_monoV)
{
   ...
   cout<<"vbfHiggsToInv_wlnuControlRegion::loop()"<<endl;

...
// Sun Apr  3 13:14:37 2016 by ROOT version 5.34/18
// from TTree tree/treeProducerDarkMatterMonoJet
// found on file: DYJetsToLL_M50_HT100to200_treeProducerDarkMatterMonoJet_tree.root
//////////////////////////////////////////////////////////

#ifndef edimarcoTree_v5_h
#define edimarcoTree_v5_h
...
public :
   ...
   Float_t         isoTrack_relIsoAn04[7];   //[nisoTrack]
   ...
   Float_t         LepGood_e5x5[5];   //[nLepGood]
   ...
   Float_t         LepGood_superCluster_correctedEnergy[5];   //[nLepGood]
   Float_t         LepGood_superCluster_energy[5];   //[nLepGood]
   Float_t         LepGood_superCluster_clustersSize[5];   //[nLepGood]
   Float_t         LepGood_superCluster_seed_energy[5];   //[nLepGood]
   ...
   Float_t         LepGood_jetRawPt[5];   //[nLepGood]
   ...
   Float_t         LepGood_jetPtRatio_Raw[5];   //[nLepGood]
   ...
   Float_t         LepGood_idEmu[5];   //[nLepGood]
   Float_t         LepGood_idIsoEmu[5];   //[nLepGood]
   ...
   edimarcoTree_v5(TTree *tree=0);
   virtual ~edimarcoTree_v5();
...
#ifdef edimarcoTree_v5_cxx
edimarcoTree_v5::edimarcoTree_v5(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("DYJetsToLL_M50_HT100to200_treeProducerDarkMatterMonoJet_tree.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("DYJetsToLL_M50_HT100to200_treeProducerDarkMatterMonoJet_tree.root");
      }
...
edimarcoTree_v5::~edimarcoTree_v5()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t edimarcoTree_v5::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t edimarcoTree_v5::LoadTree(Long64_t entry)
{
...
void edimarcoTree_v5::Init(TTree *tree)
{
   ...
   //setting branches for evVarFriend variables
...
void edimarcoTree_v5::Show(Long64_t entry)
{
...
Int_t edimarcoTree_v5::Cut(Long64_t entry)
{
...
#endif // #ifdef edimarcoTree_v5_cxx
